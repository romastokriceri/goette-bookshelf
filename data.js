...
export const authorData = {
  ...
  bio: [
    "Историк и исследователь немецко-швейцарского наследия на территории Украины.",
    "Автор многочисленных публикаций о судьбе немецких колонистов, их вкладе в развитие региона и трагических страницах депортаций.",
    "Каждая книга — это результат многолетней архивной работы и сохранения памяти о забытых судьбах."
  ]
};
