...
export const shelfDividerQuotes = {
  "shelf-1": [
    ...
    },
    {
      ...
      text: {
        ru: "Нет сомнения, что замечательное и в своём роде уникальное произведение Генриетты Львовны Гётте, не только поможет всем нам лучше разобраться в некоторых вопросах нашей многострадальной истории, о которых ранее умалчивала советская историография, сделает нас, не побоюсь сказать, лучше, чище, мудрее! И верю, что миллионы будущих читателей во всех концах бывшего Союза и за его пределами по достоинству оценят непреходящее значение этой, без преувеличения великой книги, пронизанной  высоким гуманизмом, верой в высшую справедливость – победу добра над злом!",
